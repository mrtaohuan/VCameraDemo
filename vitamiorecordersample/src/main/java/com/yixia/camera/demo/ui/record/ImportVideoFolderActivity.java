...
//加载进度条
	...
	private void initView(){
		...
		protected void onResume() {
		  ...
		  super.onResume();
		  try {
	      ArrayList<VideoFolder> folderlist = (ArrayList<VideoFolder>) loadData();
...
//			final VideoFolder item = getItem(position);
//			if (item != null && StringUtils.isNotEmpty(item.path) && getActivity() != null && isAdded()) {
//				mImportHelper.onDestory();
//				Intent intent = new Intent(getActivity(), ImportVideoSelectionActivity.class);
